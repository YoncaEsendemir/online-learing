...
function Header() {
    ...
    return (
        <header>
            <Navbar style={{backgroundColor:"#1f3747"}} variant="dark" expand="lg">
                <Container>
                    ...
                    <Navbar.Collapse id="basic-navbar-nav">
                        ...
                        <Nav>
                            ...
                            <Nav.Link href="https://www.facebook.com" target="_blank" rel="noopener noreferrer"><FaFacebook size={25}/></Nav.Link>
                            <Nav.Link href="https://www.twitter.com" target="_blank" rel="noopener noreferrer"><FaTwitter size={25}/></Nav.Link>
                            <Nav.Link href="https://www.instagram.com" target="_blank" rel="noopener noreferrer"><FaInstagram size={25}/></Nav.Link>
                        </Nav>
                    </Navbar.Collapse>
                </Container>
            </Navbar>
